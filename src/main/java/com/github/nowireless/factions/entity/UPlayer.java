...
import com.github.nowireless.factions.EconomyParticipator;
...
import com.github.nowireless.factions.util.RelationUtil;
...
public class UPlayer extends SenderEntity<UPlayer> implements EconomyParticipator
{
	...
	*/
	...
	public boolean isInOwnTerritory()
	{
		PS ps = Mixin.getSenderPs(this.getId());
		if (ps == null) return false;
		return false;// BoardColls.get().getFactionAt(ps) == this.getFaction();
	}
	...
	public boolean isInEnemyTerritory()
	{
		PS ps = Mixin.getSenderPs(this.getId());
		if (ps == null) return false;
		return false;//BoardColls.get().getFactionAt(ps).getRelationTo(this) == Rel.ENEMY;
	}
